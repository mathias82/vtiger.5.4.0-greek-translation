...
'LBL_CANCEL'=>'Ακύρωση',
'LBL_STEP_SELECT_FILE'=>'Βήμα 1ο : Επιλέξτε το αρχείο',
'LBL_BROWSE_FILES'=>'Επιλέξτε αναζήτηση και υποδείξτε το αρχείο για ανέβασμα',
'LBL_DESCRIPTION'=>'Βήμα 2ο : Γράψτε μια περιγραφή',
'LBL_OPTIONAL'=>'(προαιρετικά)',
);
