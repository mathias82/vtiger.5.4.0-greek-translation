...
'LBL_Quote_INFORMATION'=>'Πληροφορίες Οργανισμού',
...
'LBL_ANY_ADDRESS'=>'Άλλη Διεύθυνση:',
'LBL_CITY'=>'Πόλη:',
'LBL_STATE'=>'Νομός:',
'LBL_POSTAL_CODE'=>'ΤΚ:',
'LBL_COUNTRY'=>'Χώρα:',
...
'MSG_DUPLICATE' => 'Δημιουργία αυτού το Οργανισμού μπορεί δυνητικά να επιφέρει δημιουργία διπλοκαταχωρημένου Οργανισμού. Μπορείτε να επιλέξετε Οργανισμό από την παρακάτω λίστα ή μπορείτε να κάνετε κλικ στο Δημιουργία Νέου Οργανισμού για να συνεχίσετε δημιουργώντας ένα Οργανισμό από τα προηγουμένως καταχωρηθέντα δεδομένα.',
'LBL_INVITEE' => 'Επαφές',
...
'Cancelled'=>'Ακυρώθηκε',
'Received Shipment'=>'Παρελήφθη το Φορτίο',
